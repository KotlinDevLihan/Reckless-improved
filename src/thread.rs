...
use crate::{
    board::Board,
    history::{ContinuationCorrectionHistory, ContinuationHistory, CounterMoveHistory, CorrectionHistory, NoisyHistory, QuietHistory},
    nnue::Network,
...
impl ThreadData {
    pub fn new(shared: Arc<SharedContext>) -> Self {
        Self {
            ...
            counter_move_history: CounterMoveHistory::default(),
